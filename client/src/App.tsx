    ...
    <main className="app">
      ...
      <section className="hero">
        ...
        <p className="subtitle">
          Paste your CV or upload a PDF and a job description to get an instant
          match score, missing skills, red flags, and a tailored application
          message.
        </p>
      </section>
      ...
      <section className="inputGrid">
        <div className="panel">
          ...
          <label className="uploadBox">
            ...
            />
            {isParsingPdf ? "The hive is reading the pdf..." : "Upload CV PDF"}
          </label>
          <textarea
      ...
      {analysis && (
        <section className="results">
          ...
          <div className="resultGrid">
            <ResultCard title="Strong Matches" items={analysis.strongMatches} />
          ...
          <div className="messageBox liftCard">
            <div className="messageHeader">
              ...
              <button className="copyButton" onClick={copyApplicationMessage}>
